...
class TestRetrievingHistgramsFromAList():
    def testGetHistogramsInList(self, loggingMixin, retrieveRootList):
    ...
    def testGetNonExistentList(self, loggingMixin, retrieveRootList):
    ...
    def test_retrieve_object(self, loggingMixin, retrieveRootList):
        """ Test for retrieving a list of histograms from a ROOT file.
...
class TestWithRootHists():
    def testGetArrayFromHist(self, loggingMixin, testRootHists):
    ...
    def testGetArrayFromHist2D(self, loggingMixin, setZeroToNaN, testRootHists):
